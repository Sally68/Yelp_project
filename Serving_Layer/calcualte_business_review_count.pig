--load all the data
review_row = LOAD 'hdfs:///apps/hive/warehouse/Review_hive/part-m-00000' USING PigStorage('\u0001')
...
user_row = LOAD 'hdfs:///apps/hive/warehouse/User_hive/part-m-00000' USING PigStorage('\u0001')
...
STORE business_review_count_w_active_user INTO 'hdfs:///user/sally/output/temp1' USING PigStorage('\u0001');
...
STORE business_review_count INTO 'hdfs:///user/sally/output/business_w_active_review_count' USING PigStorage('\u0001');
